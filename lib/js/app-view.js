...
window.App = (function(app){
	...
	App.view = {
		...
		initScroller: function(){
			...
			if (typeof(IScroll) == 'function') {
				App.view.Scroller = new IScroll(container, {
					...
					useTransition:			/*Platform.android ? false : */true,
					useTransform:			/*Platform.android ? false : */true,
					HWCompositing:			/*Platform.android ? false : */true
				});
		...
		onSegmentdidchange: function(e){
			...
			//update navTitle (for mobile only)
			$navTitle.text( 'Week ' + (currentSeg+1) );
			//updateWeeksNavBtns
